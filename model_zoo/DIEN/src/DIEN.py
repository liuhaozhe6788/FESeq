...
class DIEN(BaseModel):
    ...
    def __init__(self,
        ...
        feature_dim = feature_dim + feature_map.sum_emb_out_dim() - embedding_dim * len(self.dien_neg_seq_field)
    ...
    def forward(self, inputs):
        ...
        for idx, (target_field, sequence_field) in enumerate(
            ...
            if "neg_"+ target_field in self.dien_neg_seq_field:
    ...
    def compute_loss(self, return_dict, y_true):
        ...
        if self.aux_loss_alpha > 0:
            for i in range(len(self.dien_neg_seq_field)):
