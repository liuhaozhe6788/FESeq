...
if __name__ == '__main__':
    ...
    # for attn_dropout in range(1, 10):
    #     for net_dropout in range(1, 10):
    #         params["attention_dropout"] = attn_dropout/10
    #         params["net_dropout"] = net_dropout/10
    ...
    if args["mode"] == "train":
        ...
        valid_result = model.evaluate(valid_gen, test=True)
