...
echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_0_eleme
echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_0_bundle
echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_0_ml10m

echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_1_eleme
echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_1_bundle
echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_1_ml10m
...
echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_2_ml10m
...
echo "=== Training FESeq===" && python run_expid.py --gpu 0 --expid FESeq_3_ml10m
